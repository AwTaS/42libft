...
LST_SRCS	:=	ft_atoi.c \
				...
				ft_printf/print_utils/ft_printf_decimal_number.c \
				ft_printf/print_utils/ft_printf_hex_number.c \
				ft_printf/print_utils/ft_printf_ptr.c \
				ft_printf/print_utils/ft_printf_unsigned_int.c \
